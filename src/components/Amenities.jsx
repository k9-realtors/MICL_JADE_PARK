  ...
  return (
    <section className="section shadow-sm lazyloaded" id="amenities">
      ...
      <div className="owl-carousel-fp owl-carousel owl-theme ticket-amenities">
        ...
        >
          <img
            src="images/lntevaraheightsmultipurposesportscourt.webp"
            alt="aminities"
          />
        </div>
        <div
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheights247security.webp" alt="aminities" />
        </div>
        <div
          className="item"
          data-form="lg"
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheightsamphitheatre.webp" alt="aminities" />
        </div>
        <div
          className="item"
          data-form="lg"
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheightsgym.webp" alt="aminities" />
        </div>
        <div
          className="item"
          data-form="lg"
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheightsjoggingtrack.webp" alt="aminities" />
        </div>
        <div
          className="item"
          data-form="lg"
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheightsyoga.webp" alt="aminities" />
        </div>
        <div
          className="item"
          data-form="lg"
          ...
          data-target="#enqModal"
        >
          <img src="images/lntevaraheightsswimmingpool.webp" alt="aminities" />
        </div> */}
      </div>
