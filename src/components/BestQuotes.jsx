...
const BestQuotes = () => {
  ...
  return (
    <div className="micro-side text-center">
      <div className="contact-acts text-center">
        <div className="orga">
          <button onClick={handleShowModal}>Organize Site Visit</button>
          <button onClick={handleShowModal}>+917506090422</button>
        </div>
        <div className="get-call">
          <button onClick={handleShowModal}>Request Call Back</button>
        </div>
      </div>
      ...
      >
        ...
        >
          <span
            className="d-block form-heading font-weight-bold my-1"
            style={{ paddingTop: "0rem", fontSize: "1.1rem" }}
          >
            Get The Best Quote
          </span>
          <input
      ...
      >
        <span className="form-last-heading lazyloaded" data-expand="-1">
          ...
          Free Cab Facilitiy For Site Visit
        </span>
      </h5>
      <div className="whatsapp-icon">
        {/* for web whatsapp https://web.whatsapp.com/send?phone=917506090422&text=Hi,%20I%20Would%20Like%20To%20Know%20More%20About%20MICL%20Jade%20Park Project.%20Please%20Share%20More%20Details! */}
        <a
          href="https://web.whatsapp.com/send?phone=917506090422&text=Hi,%20I%20Would%20Like%20To%20Know%20More%20About%20MICL%20Jade%20Park Project.%20Please%20Share%20More%20Details!"
          target="_blank"
      ...
      {/* <div class="contact-actions">
        <a href="tel:+917506090422" class="phone-link">
          <div class="phone-wrapper">
            <span>+91 75060 90422</span>
          </div>
        </a>
        <button class="callback-btn enqModal" data-form="sm">
